...
import { createWebsite } from "./graphql/mutations";
...
export default function WebsiteCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createWebsite.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "WebsiteCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
