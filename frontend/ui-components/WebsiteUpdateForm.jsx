...
import { getWebsite } from "./graphql/queries";
...
export default function WebsiteUpdateForm(props) {
  const {
    id: idProp,
    website: websiteModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = websiteRecord
      ? { ...initialValues, ...websiteRecord }
      : initialValues;
    setWebsiteId(cleanValues.websiteId);
  ...
  const [websiteRecord, setWebsiteRecord] = React.useState(websiteModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getWebsite.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getWebsite
        : websiteModelProp;
    ...
    queryData();
  }, [idProp, websiteModelProp]);
  React.useEffect(resetStateValues, [websiteRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateWebsite.replaceAll("__typename", ""),
            variables: {
              input: {
                id: websiteRecord.id,
                ...modelFields,
      ...
      {...getOverrideProps(overrides, "WebsiteUpdateForm")}
      {...rest}
    >
      <TextField
        label="Website id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || websiteModelProp)}
