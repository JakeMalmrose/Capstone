...
import { createSummarizer } from "./graphql/mutations";
...
export default function SummarizerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSummarizerId(initialValues.summarizerId);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSummarizer.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SummarizerCreateForm")}
      {...rest}
    >
      <TextField
        label="Summarizer id"
